...
import { Row, Col, Form, ListGroup, Container} from 'reactstrap'
        ...
        <Col lg='8'>
          ...
          <div className="tour__info">
            ...
            <div className="tour__extra-details">
              ...
              <span><i class="ri-money-dollar-circle-line"></i>Rp{price} Per Orang</span>
              <span><i class="ri-map-pin-time-line"></i>{distance} k/m</span>
              <span><i class="ri-group-line"></i>{maxGroupSize} orang</span>
            </div>
            <h5>Description</h5>
            <p>{desc}</p>
          </div>
                    ...
                    <div className='w-100'>
                      <div className='d-flex align-items-center justify-content-between'>
                        <div>
                          ...
                          <p>
                            {new Date(review.createdAt).toLocaleDateString("id-ID", options)}
                          </p>
                        </div>
